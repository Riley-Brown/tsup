...
var loadJson = async (filepath) => {
  try {
    return _chunkG22UJFQCjs.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${colors.default.bold(padRight(name, maxLength))}${colors.default.green(
